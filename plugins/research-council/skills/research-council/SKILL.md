...
description: >-
  Pressure-test a research decision, benchmark, experiment, result, or paper
  claim through a critic-weighted panel (Skeptic/Reviewer-2, Methodologist,
  Theorist, Taste, Naive-reader, Feasibility), then synthesize one verdict.
  Auto-detects computational vs wet-lab work and routes the rigor lenses
  accordingly. Runs entirely in Claude via sub-agents; no external APIs or data
  egress, so it is safe for unpublished work. Triggers: "council this",
  "reviewer 2 this", "pressure-test/stress-test/red-team this", "is this
  benchmark/experiment sound", "what will a reviewer attack", "should I pursue
  X or Y", "am I fooling myself". Do NOT trigger on factual lookups, simple
  implementation, or questions answered by just running the computation or the
  experiment.
---
